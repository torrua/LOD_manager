...
<style>
  ...
  .sec-hd:not(.plain):hover .sec-title {
    opacity: 0.8;
  }
  ...
  .wchip {
    ...
    font-weight: 500;
    color: var(--teal);
    background: rgba(86, 186, 180, 0.07);
    border: 1px solid rgba(86, 186, 180, 0.2);
    border-radius: var(--r-md);
    cursor: pointer;
  ...
  .wchip:hover {
    background: rgba(86, 186, 180, 0.18);
    border-color: rgba(86, 186, 180, 0.45);
  }
  .wchip.rem {
    color: var(--text3);
  ...
  .wchip.rem:hover {
    ...
    border-color: rgba(196, 68, 68, 0.25);
