...
<style>
  ...
  .ed-name{font-size:var(--fs-xl);font-weight:700;color:var(--text);margin:0;line-height:1.2}
  ...
  .wchip.rem:hover{background:rgba(196,68,68,.08);border-color:rgba(196,68,68,.25);color:var(--red,var(--red))}
